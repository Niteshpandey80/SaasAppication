...
import { Edit, Hash, Image, ImagesIcon, Sparkles } from 'lucide-react';

const GenerateImages = () => {
  const ImageStyle = [
        'Realistic' , 'Ghilbli style ' , 'Anime style' , 'Cartoon style' , 'Fantasy style  ' , 'Realistic style' , '3D style' , 'Protrait style'
      ]
         ...
         <div className='flex items-center gap-3'>
             ...
             <div className='flex-1 flex justify-center items-center '>
              <div className='text-sm flex flex-col items-center gap-5 text-gray-400'>
                <ImagesIcon className='w-9 h-9 text-[#4A7AFF]'/>
                <p>Enter a topic and click ""</p>
             </div>
         </div>
       </div>
    </div>
